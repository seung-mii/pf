...
export const careersData: CareerInfo[] = [
  {
    category: "CAREER",
    title: "SNUAILAB SW 개발팀 [인턴]",
    details: [
      "- 자사 웹앱의 이슈 약 56% 해결",
      "- 자사 웹앱의 불편점을 개선하기 위해 Figma로 설계한 UI/UX가 실제 제품 수정 방향으로 채택",
  ...
  },
  {
    ...
    details: [
      ...
      "- 640시간 (16주) 이상 웹 개발 (프론트엔드 & 백엔드) 이론 교육",
      "- 개인 & 팀 프로젝트 진행 (현업 멘토링 포함)",
      "- JavaScript, React, SpringBoot, MongoDB 외 다수 웹관련 기술 사용",
    ],
