...
export const contentsData: ContentInfo[] = [
  {
    ...
    paragraphs: [
      ...
      "단순한 편리함을 넘어, 사용자에게 의미 있는 가치를 제공하고, 삶을 변화시키는 서비스를 개발하고 싶습니다.",
    ],
    highlights: [{ text: "진정으로 필요로 하는 서비스", color: "#FFD700" }, { text: "사용자에게 의미 있는 가치를 제공하고, 삶을 변화시키는 서비스", color: "#FFD700" }],
  },
  {
    id: 1,
