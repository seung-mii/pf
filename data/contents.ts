...
export const contentsData: ContentInfo[] = [
  {
    id: 0,
    paragraphs: [
      "사용자 경험과 피드백을 중요하게 생각하며",
      "사용자가 진정으로 필요로 하는 서비스를 개발하고 싶습니다.",
      "교통약자를 위한 저상버스 정보 시스템과 코로나로 인해 증가한 배달비 부담을 줄이기 위한 어플을 개발하여 수상한 경험이 있습니다.",
    ],
    highlights: [{ text: "사용자가 진정으로 필요로 하는 서비스", color: "#ffdf00" }],
  },
  {
    id: 1,
    paragraphs: [
      "인턴 근무 당시, 사용자와 직접 소통하며 편의성을 개선한 신규 툴을 개발하여",
      "작업 효율을 40% 향상시키고 월 150만 원의 비용을 절감한 경험이 있습니다.",
    ],
    highlights: [{ text: "작업 효율을 40% 향상시키고 월 150만 원의 비용을 절감", color: "#ffdf00" }],
  },
  {
    id: 2,
    paragraphs: [
    ...
    highlights: [{ text: "성능 최적화", color: "#ffdf00" }, { text: "반응형 웹", color: "#ffdf00" }],
  },
  {
    id: 3,
    paragraphs: [
    ...
    highlights: [{ text: "재사용성과 유지보수를 고려", color: "#ffdf00" }],
  },
];