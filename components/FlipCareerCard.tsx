  ...
  return (
    ...
    >
      <div className="front absolute w-full h-full flex flex-col justify-center rounded-xl shadow-md text-base px-3 pt-2 pb-3 sm:px-6 sm:pt-2 sm:pb-6 text-fontColor bg-darkPurple backface-hidden">
        <div className="flex items-center justify-center text-md font-bold text-fontColor h-1/4 whitespace-pre-line">
          {formattedTitle}
        </div>
        <div className="text-s text-left leading-4 sm:leading-5 flex-grow text-fontColor">
          {details.map((line, i) => (
