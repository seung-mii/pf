    ...
    <div className="flex flex-col sm:flex-row justify-between items-center">
      <div className="flex items-center gap-3 sm:gap-5 mb-4 sm:mb-2">
        ...
        <div className="text-left">
          <h1 className="text-m sm:text-l font-semibold m-0">신승미</h1>
      ...
      <div className="text-center">
        ...
        <div className="text-center inline-flex items-center justify-center gap-1 mt-1 group relative">
          <Link href="https://seung-mi-resume.vercel.app/" target="_blank" className="text-s m-0 hover:cursor-circleDarkHover flex items-center relative">
            <Image src={Right} alt="right arrow" className="w-2 h-2 sm:w-3 sm:h-3 transition-transform duration-300 ease-in-out rotate-45 group-hover:rotate-0 relative mr-1" />
            Resume
          </Link>
