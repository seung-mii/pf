...
export function CareerSection() {
  ...
  return (
    <div className="w-full h-[300vh] md:h-[350vh] lg:h-[400vh] font-noto" ref={wrapperRef}>
      <div
        className="sticky top-0 h-screen flex items-center justify-center overflow-visible sm:overflow-hidden"
        ref={stickyRef}
      >
        <div className="absolute w-full sm:w-[95vw] h-auto min-h-[87%] sm:min-h-full box-border overflow-visible flex gap-4 sm:gap-6 justify-center items-center flex-wrap [perspective:1000px] [transform-style:preserve-3d]">
