...
const InfoSection: React.FC<InfoSectionProps> = ({ information }) => {
  ...
  return (
    <div className="h-[80vh] sm:h-screen sm:grid sm:grid-cols-2 sm:gap-6 px-8">
      ...
      <div className={`flex flex-col items-center w-full my-3 gap-2 justify-center ${!hasVideo0 ? "col-span-2" : ""}`}>
      ...
      <div className="flex flex-col gap-4 sm:gap-6 col-span-2 mb-12">
        {information.challenge && (
          <>
            <div className="border-solid border-thin border-darkBlue rounded-md px-2 py-3 sm:p-4 my-2 mx-0 sm:mx-10 relative shadow-sm">
              <h1 className="absolute -top-2 left-4 bg-top text-s sm:text-m px-2">Challenge</h1>
            ...
            <div className="border-solid border-thin border-darkBlue rounded-md px-2 py-3 sm:p-4 mx-0 sm:mx-10 relative shadow-sm">
              <h1 className="absolute -top-2 left-4 bg-top text-s sm:text-m px-2">Approach</h1>
              <ul className="list-disc pl-4 text-xs sm:text-s leading-3 sm:leading-5 sm:mt-1">
        ...
        {information.result && (
          <div className="border-solid border-thin border-darkBlue rounded-md px-2 py-3 sm:p-4 my-2 mx-0 sm:mx-10 relative shadow-sm">
            <h1 className="absolute -top-2 left-4 bg-top text-s sm:text-m px-2">Result</h1>
              <ul className="list-disc pl-4 text-xs sm:text-s leading-3 sm:leading-5 sm:mt-1">
